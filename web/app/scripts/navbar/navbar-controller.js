(function () {
    ...
    function NavbarController($rootScope, $scope, $state, $modal, $translate, $window,
        ...
        function init() {
            setLanguageInfo();
            setUserInfo();
            console.log("Après changement d'état, utilisateur authentifié :", ctl.authenticated);
        ...
        function setFilters(state) {
            ...
            ctl.isFilterPage = _.includes(filterPages, state.label);
        }
        ...
        function setStates() {
            ...
            console.log("ctl.stateSelected:", ctl.stateSelected);
        ...
        function setUserInfo() {
            ...
            console.log("Utilisateur authentifié :", ctl.authenticated); 
