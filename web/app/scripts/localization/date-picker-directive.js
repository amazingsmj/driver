(function() {
    ...
    function DatePicker($timeout, DateLocalization) {
        ...
        function link(scope, element) {
            ...
            var regionalOptions = $.calendarsPicker.regionalOptions[dateConfig.language] || $.calendarsPicker.regionalOptions['en']; // fallback to 'en' if not defined
            $.calendarsPicker.setDefaults(regionalOptions);
