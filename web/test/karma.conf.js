...
module.exports = function(config) {
  ...
  config.set({
    ...
    files: [
      ...
      'bower_components/ng-file-saver/dist/angular-file-saver.bundle.js',
      ...
      'bower_components/kbw-plugin/src/js/jquery.plugin.js',
      'bower_components/world-calendars/src/js/jquery.calendars.js',
