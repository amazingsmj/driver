...
DATABASES = {
    'default': {
        'ENGINE': 'django.contrib.gis.db.backends.postgis',  # Utilisation de PostGIS pour la gestion des données géospatiales
        'NAME': 'driver',  # Nom de la base de données
        'HOST': 'localhost',  # Hôte de la base de données (localhost par défaut)
        'PORT': '5432',  # Port de la base de données (5432 par défaut pour PostgreSQL)
        'USER': 'prooftag',  # Nom d'utilisateur PostgreSQL
        'PASSWORD': '1234',  # Mot de passe de l'utilisateur PostgreSQL
        'CONN_MAX_AGE': 3600,  # Durée maximale de connexion en secondes
        'OPTIONS': {
            'sslmode': 'require'  # Option SSL pour sécuriser la connexion
        }
    }
}
...
HOST_URL = os.environ.get('DRIVER_APP_HOST') or os.environ.get('HOSTNAME') or "http://localhost:8000"
